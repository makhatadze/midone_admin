...
@section('subhead')
    <title>Insite - Update Departments</title>
@endsection

@section('subcontent')
    <div class="intro-y flex items-center mt-8">
        <h2 class="text-lg font-medium mr-auto font-helvetica">
            Update departments </h2>
    </div>
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 lg:col-span-8">
            <div class="intro-y box p-5">
                {!! Form::open(['route' => ['departmentsUpdate',$department->id],'method' =>'post',]) !!}
                <div class="sm:grid grid-cols-1 gap-1 mb-4">
                    <div class="relative mt-4 {{ $errors->has('department_name') ? ' has-error' : '' }}">
                        ...
                        {{ Form::text('department_name', $department->name, ['class' => 'input w-full border mt-2 col-span-2', 'no','placeholder'=>'Department Name...','id' => 'department_name']) }}
